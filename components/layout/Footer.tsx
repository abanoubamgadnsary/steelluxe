    ...
    <footer className="bg-charcoal-900 text-charcoal-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="mb-4">
              ...
              <p className="text-2xs tracking-[0.25em] text-charcoal-400 uppercase mt-0.5">Fine Steel Jewelry</p>
            </div>
            <p className="text-sm text-charcoal-400 leading-relaxed mb-6 font-body">
              Premium 316L stainless steel jewelry crafted for the modern woman. Tarnish-free, water-resistant, made to last forever.
            </p>
          ...
          {/* Shop */}
          <div>
            <h3 className="font-display text-lg font-normal text-cream-100 mb-5 tracking-wide">Shop</h3>
            <ul className="space-y-3">
              {[
                ...
                <li key={href}>
                  <Link href={href} className="text-sm text-charcoal-400 hover:text-gold-300 transition-colors duration-200">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          {/* Help */}
          <div>
            <h3 className="font-display text-lg font-normal text-cream-100 mb-5 tracking-wide">Help</h3>
            <ul className="space-y-3">
              {[
                { label: 'FAQ',              href: '/faq'            },
          ...
          {/* Contact */}
          <div>
            <h3 className="font-display text-lg font-normal text-cream-100 mb-5 tracking-wide">Contact</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-sm text-charcoal-400">
                <Mail size={16} className="mt-0.5 text-gold-400 shrink-0" />
                <a href="mailto:hello@steelluxe.com" className="hover:text-gold-300 transition-colors">hello@steelluxe.com</a>
              </li>
              <li className="flex items-start gap-3 text-sm text-charcoal-400">
                <Phone size={16} className="mt-0.5 text-gold-400 shrink-0" />
                <a href="tel:+201234567890" className="hover:text-gold-300 transition-colors">+20 123 456 7890</a>
              </li>
              <li className="flex items-start gap-3 text-sm text-charcoal-400">
            ...
            {/* Newsletter */}
            <div className="mt-6">
              <p className="text-xs text-charcoal-400 mb-3 tracking-wide">SUBSCRIBE FOR UPDATES</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-charcoal-500">© {year} SteelLuxe. All rights reserved.</p>
          <div className="flex items-center gap-4">
            <img src="/payment-icons.png" alt="Payment methods" className="h-6 opacity-50" onError={() => {}} />
