...
export function getShippingCost(governorate: string): number {
  return EGYPT_GOVERNORATES.find(g => g.governorate === governorate)?.cost ?? 80;
}

export function getDeliveryEstimate(governorate: string): string {
  return EGYPT_GOVERNORATES.find(g => g.governorate === governorate)?.estimatedDays ?? '3-5';
}
...
export function getDiscountAmount(type: 'percentage' | 'fixed', value: number, total: number): number {
  return type === 'percentage' ? Math.round(total * value / 100) : Math.min(value, total);
}
...
export const DEMO_PRODUCTS = [
  {
    ...
    description: 'Delicate stainless steel chain with a celestial star pendant. Water-resistant and tarnish-free.', shortDescription: 'Celestial star pendant necklace',
    material: '316L Stainless Steel', tags: ['necklace', 'star', 'celestial'], stock: 50, sold: 120, rating: 4.8, reviewCount: 45, isNew: true, isBestSeller: true, isFeatured: true, discount: 25,
  },
  {
    name: 'Pearl Drop Earrings', slug: 'pearl-drop-earrings',
    price: 280, category: 'earrings',
    images: ['https://images.unsplash.com/photo-1630019852942-f89202989a59?w=800', 'https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=800'],
    description: 'Elegant pearl drop earrings set in polished stainless steel. Perfect for every occasion.', shortDescription: 'Elegant pearl drop earrings',
    material: '316L Stainless Steel + Synthetic Pearl', tags: ['earrings', 'pearl', 'elegant'], stock: 35, sold: 89, rating: 4.9, reviewCount: 32, isNew: false, isBestSeller: true, isFeatured: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Classic herringbone-pattern stainless steel bracelet. Bold yet refined.', shortDescription: 'Herringbone chain bracelet',
    material: '316L Stainless Steel', tags: ['bracelet', 'herringbone', 'bold'], stock: 25, sold: 145, rating: 4.9, reviewCount: 61, isNew: false, isBestSeller: true, isFeatured: false, discount: 20,
  },
  {
    ...
    description: 'Multi-layer necklace set featuring crescent moon and star pendants.', shortDescription: 'Multi-layer moon necklace set',
    material: '316L Stainless Steel', tags: ['necklace', 'moon', 'layered', 'set'], stock: 20, sold: 78, rating: 4.6, reviewCount: 22, isNew: true, isBestSeller: false, isFeatured: true,
  },
  {
    ...
    description: 'Set of 3 graduated hoop earrings. Mix and match for the perfect look.', shortDescription: 'Set of 3 hoop earrings',
    material: '316L Stainless Steel', tags: ['earrings', 'hoops', 'set'], stock: 60, sold: 203, rating: 4.8, reviewCount: 87, isNew: false, isBestSeller: true, isFeatured: false,
  },
  {
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1573408301185-9519f94816b5?w=800'],
    description: 'Sleek snake chain bracelet with a delicate lobster clasp.', shortDescription: 'Sleek snake chain bracelet',
    material: '316L Stainless Steel', tags: ['bracelet', 'snake', 'chain'], stock: 45, sold: 92, rating: 4.7, reviewCount: 38, isNew: true, isBestSeller: false, isFeatured: false, discount: 16,
  },
];
